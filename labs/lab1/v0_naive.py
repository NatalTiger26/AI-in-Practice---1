...
'''
LiteLLM:WARNING: vertex_and_google_ai_studio_gemini.py:1083 - 
DeprecationWarning: `temperature`, `top_p`, and `top_k` continue to function for Gemini 3+ (gemini-3.5-flash-lite) but are planned for removal in a future release. 
